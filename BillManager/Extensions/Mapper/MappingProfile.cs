...
{
    public class MappingProfile : Profile//co na co mapujemy
    {
        public MappingProfile()
        {
            CreateMap<ApplicationUser, UserDTO>() //From ApplicationUser to destinationMember UserDTO
                .ForMember(vm => vm.Id, map => map.MapFrom(m => m.Id))
                .ForMember(vm => vm.Email, map => map.MapFrom(m => m.Email))
                .ForMember(vm => vm.IsPaid, map => map.MapFrom(m => m.IsPaid))
                .ForMember(vm => vm.PasswordHash, map => map.MapFrom(m => m.PasswordHash))
